...
public class ClaimServiceImpl implements ClaimService{
	...
	@Override
	public DataResult<List<Claim>> getProjectManagerClaims() {
		return new SuccessDataResult<List<Claim>>(this.claimRepository.getProjectManagerClaims());
	}



	@Override
	public DataResult<List<Claim>> getTeamLeaderClaims() {
		return new SuccessDataResult<List<Claim>>(this.claimRepository.getTeamLeaderClaims());
